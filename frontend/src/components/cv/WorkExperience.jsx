...
const WorkExperience = () => {
  ...
  useEffect(() => {
    if (CVData.workExperience) {
      setExperiences(CVData.workExperience);
    }
  }, [CVData.workExperience]);

  const handleAiSuggestions = async () => {
    setLoading(true);
    const aiText = await getAiSuggestions(`Write a professional and concise work experience description for a CV based on these details:
- Company: ${companyName}
- Position: ${jobTitle}
